  ...
  return (
    <div className="shrink-0 h-full w-85 p-5 rounded-xl border-2 border-[#212836] bg-[#121926] ">
      ...
      <div className="mt-6 flex items-center justify-center w-full">
        <button className='px-3 py-1 text-white border flex items-center  justify-center gap-1 border-green-500 bg-green-500 text-sm rounded-full'> <span><FaCircleCheck /> </span> Completed</button>
      </div>
    </div>
  );
};
